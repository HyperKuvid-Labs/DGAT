  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "dgat-border": "hsl(var(--border))",
        "dgat-border2": "hsl(var(--border2))",
        "dgat-text": "hsl(var(--text))",
        "dgat-muted": "hsl(var(--muted))",
        "dgat-subtle": "hsl(var(--subtle))",
        "dgat-tag": "hsl(var(--tag-bg))",
        "dgat-nav": "hsl(var(--nav-bg))",
        "dgat-invert-bg": "hsl(var(--invert-bg))",
        "dgat-invert-text": "hsl(var(--invert-text))",
        "dgat-code-bg": "hsl(var(--code-bg))",
        "dgat-code-border": "hsl(var(--code-border))",
        primary: {
