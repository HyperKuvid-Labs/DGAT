...
export const context = tool({
  description: "Get comprehensive context for a file from DGAT's dependency graph: what it does, what it imports, what depends on it, and blast radius",
  args: {
...
export const impact = tool({
  description: "Analyze the blast radius of changing a file — which other files would be affected, ranked by risk",
  args: {
...
export const search = tool({
  description: "Search files in the codebase by name or their AI-generated description",
  args: {
...
export const blueprint = tool({
  description: "Get the project architecture blueprint — AI-generated overview of the entire codebase",
  args: {},
  async execute() {
    try {
